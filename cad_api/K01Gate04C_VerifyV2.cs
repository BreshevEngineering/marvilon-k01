...
namespace Marvilon.K01.Gate04C.VerifyV2
{
    public sealed class Rpt
    {
        public string schema="k01_gate04c_verify_v2";
        ...
        public bool j2_clocking_m3=false;
    ...
    public static class Program
    {
        ...
        const string P003C=@"D:\Marvilon\K01\cad\candidates\gate04c\K01-P-003_Cartridge_Body_GATE04C_CANDIDATE.SLDPRT";
        const string P007C=@"D:\Marvilon\K01\cad\candidates\gate04c\K01-P-007_Hermetic_Magnetic_Can_GATE04C_CANDIDATE.SLDPRT";
        const string VDIR=@"D:\Marvilon\K01\cad\candidates\gate04c\verification";
        const string VASM=@"D:\Marvilon\K01\cad\candidates\gate04c\verification\K01-A-001_GATE04C_VERIFY_V2.SLDASM";
        ...
        public static int Main(string[] args)
        {
            try
            {
                ...
                logPath=Path.Combine(RDIR,"K01_GATE04C_VERIFY_V2_"+stamp+".log");
                jsonPath=Path.Combine(RDIR,"K01_GATE04C_VERIFY_V2.json");
                File.WriteAllText(logPath,"K01 Gate04C Verify V2\r\n");
        ...
        static void Verify()
        {
            ...
            try
            {
                ...
                Face2 hole3=FindCyl(d3,2.50,0.10,new double[]{ey,ez});
                Face2 hole7=FindCyl(d7,3.40,0.10,new double[]{ey,ez});
                ...
                R.j2_clocking_m3=AddMate(asm,doc,c3,hole3,c7,hole7,
                    (int)swMateType_e.swMateCONCENTRIC,(int)swMateAlign_e.swMateAlignCLOSEST,
                    "K01_J2_CLOCKING_M3");
                if(!R.j2_clocking_m3) throw new Exception("Clocking mate failed");
                ...
                SetProp(doc,"K01_GATE","Gate04C_VERIFY_V2");
                SetProp(doc,"J2_MateArchitecture",
                    "P003/P007 face + D14.10 pilot + one M3 hole axis");
                Save(doc,"FINAL Gate04C Verify V2");

                R.notes.Add("Legacy Concentric5 and Coincident5 suppressed, not deleted.");
