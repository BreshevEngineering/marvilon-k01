...
namespace Marvilon.K01.Gate04C.Drawings
{
    ...
    {
        public string schema = "k01_gate04c_typed_drawings_v1";
    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                LoadConfig();
                Prepare();
                Log("K01 Gate04C typed DRAWINGS v1");
                Connect();
                ...
                R.status = "PASS";
                R.checks.Add("PASS: K01-D-003 and K01-D-006 DRAFT_API drawings generated as native SLDDRW + PDF.");
                SaveReport();
                Log("STATUS=PASS");
                return 0;
            }
        ...
        static void Prepare()
        {
            ...
            LogPath = Path.Combine(Cfg.paths.report_dir, "K01_GATE04C_TYPED_DRAWINGS_" + stamp + ".log");
            ReportPath = Path.Combine(Cfg.paths.report_dir, "K01_GATE04C_TYPED_DRAWINGS.json");
            File.WriteAllText(LogPath, "K01 Gate04C strongly typed drawing generation\r\n");
        }
        ...
        {
            string notes =
                "DRAFT_API - NOT RELEASED\r\n" +
                "K01-D-003 / K01-P-003 Cartridge Body / Gate04C\r\n" +
                "MATERIAL: " + Cfg.P003.material + "\r\n" +
                "J2 FLANGE: OD36; existing 5 mm rear zone; rear mating datum station retained.\r\n" +
        ...
        static void GenerateP007()
        {
            string notes =
                "DRAFT_API - NOT RELEASED\r\n" +
                "K01-D-006 / K01-P-007 Hermetic Magnetic Can / Gate04C\r\n" +
        ...
        static string[] GenerateDrawing(string modelPath, string drawingNo, string engineeringNote)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    try
                    {
                        Note n = dm.InsertNote(engineeringNote);
                        if (n != null)
                        {
                    ...
                    SetProperty(dm, "K01_DrawingStatus", "DRAFT_API");
                    SetProperty(dm, "K01_SourceModel", modelPath);

                    dm.ForceRebuild3(false);

                    string stem = drawingNo + "_" + Path.GetFileNameWithoutExtension(modelPath) + "_DRAFT_API";
