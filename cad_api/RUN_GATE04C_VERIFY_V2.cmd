...
echo [1/2] Compiling...
"%CSC%" /nologo /platform:x64 /target:exe /out:"bin\K01Gate04C_VerifyV2.exe" ^
 /reference:"%SLD%" /reference:"%CONST%" /reference:System.Web.Extensions.dll ^
 "K01Gate04C_VerifyV2.cs"
...
echo D:\BreshevEngineering\marvilon-k01\reports\cad\current\K01_GATE04C_VERIFY_V2.json
echo D:\BreshevEngineering\marvilon-k01\reports\cad\current\K01_GATE04C_VERIFY_V2_*.log
echo.
pause
exit /b %RC%
