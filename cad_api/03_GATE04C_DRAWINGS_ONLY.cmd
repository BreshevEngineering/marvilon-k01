...
echo ================================================================================
echo MARVILON K01 Gate04C - DRAFT API DRAWINGS
echo ================================================================================
...
echo Compiler        : %CSC%
echo.
echo [1/2] Compiling K01Gate04C_Drawings.cs...
"%CSC%" /nologo /platform:x64 /target:exe /out:"bin\K01Gate04C_Drawings.exe" /reference:"%SLD%" /reference:"%CONST%" /reference:System.Web.Extensions.dll "K01Gate04C_Drawings.cs"
if errorlevel 1 (
  echo.
  echo COMPILE FAILED.
...
echo.
echo [2/2] Running K01Gate04C_Drawings.exe...
"bin\K01Gate04C_Drawings.exe"
set "RC=%ERRORLEVEL%"
if not "%RC%"=="0" (
  echo.
