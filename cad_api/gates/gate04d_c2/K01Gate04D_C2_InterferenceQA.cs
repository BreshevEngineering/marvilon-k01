...
namespace Marvilon.K01.Gate04D_C2.InterferenceQA
{
    ...
    {
        public string schema="k01_gate04d_c2_interference_v1";
    ...
    {
        const string ASM=@"D:\Marvilon\K01\cad\candidates\gate04d_c2\verification\K01-A-001_GATE04D_C2_VERIFY.SLDASM";
        ...
        public static int Main()
        {
            try{
                ...
                logPath=Path.Combine(RDIR,"K01_GATE04D_C2_INTERFERENCE_"+stamp+".log");
                jsonPath=Path.Combine(RDIR,"K01_GATE04D_C2_INTERFERENCE.json");
                File.WriteAllText(logPath,"K01 Gate04D-C2 interference QA\r\n");
