...
namespace Marvilon.K01.Gate04D_C2
{
    ...
    {
        public string schema = "k01_gate04d_c2_typed_build_v1";
    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                LoadConfig();
                Prepare();
                Log("K01 Gate04D-C2 typed BUILD v1");
                Connect();
                ...
                R.status = "PASS";
                R.checks.Add("PASS: stable P003/P007 were copied; only Gate04D-C2 candidate files were modified.");
                SaveReport();
                Log("STATUS=PASS");
                return 0;
            }
        ...
        static void Prepare()
        {
            ...
            LogPath = Path.Combine(Cfg.paths.report_dir, "K01_GATE04D_C2_TYPED_BUILD_" + stamp + ".log");
            ReportPath = Path.Combine(Cfg.paths.report_dir, "K01_GATE04D_C2_TYPED_BUILD.json");
            File.WriteAllText(LogPath, "K01 Gate04D-C2 strongly typed CAD build\r\n");
        }
        ...
        static void PreflightC2Packaging()
        {
            ...
            R.checks.Add("PASS C2 packaging arithmetic: inner/outer ligament and head envelope.");
        ...
        static void BuildP003()
        {
            ...
            try
            {
                ...
                SetProperty(doc, "K01_GATE", "Gate04D_C2");
                ...
                R.checks.Add("PASS P003 C2: OD33 flange + existing seal gland + 3x M2.5 seed/pattern + D14.10x1.50 pilot.");
                Log("P003 PASS");
            }
            finally
            {
        ...
        static void BuildP007()
        {
            ...
            try
            {
                ...
                R.checks.Add("PASS P007 C2: OD33x3 flange + 3x D2.90 seed/pattern; L35 and thin can retained.");
                Log("P007 PASS");
            }
            finally
            {
