...
namespace Marvilon.K01.Gate04D_C2R1.Drawings
{
    ...
    {
        public string schema = "k01_gate04d_c2r1_typed_drawings_v1";
    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                LoadConfig();
                Prepare();
                Log("K01 Gate04D-C2R1R1 typed DRAWINGS DRAFT v1");
                Connect();
                ...
                R.status = "PASS";
                R.checks.Add("PASS: K01-D-003 and K01-D-006 DRAFT_C2R1_API drawings generated as native SLDDRW + PDF.");
                SaveReport();
                Log("STATUS=PASS");
                return 0;
            }
        ...
        static void Prepare()
        {
            ...
            LogPath = Path.Combine(Cfg.paths.report_dir, "K01_GATE04D_C2R1_TYPED_DRAWINGS_" + stamp + ".log");
            ReportPath = Path.Combine(Cfg.paths.report_dir, "K01_GATE04D_C2R1_TYPED_DRAWINGS.json");
            File.WriteAllText(LogPath, "K01 Gate04D-C2R1 strongly typed drawing generation\r\n");
        }
        ...
        {
            string notes =
                "DRAFT_C2R1_API - NOT RELEASED\r\n" +
                "K01-D-003 / K01-P-003 Cartridge Body / Gate04D-C2R1\r\n" +
        ...
        static void GenerateP007()
        {
            string notes =
                "DRAFT_C2R1_API - NOT RELEASED\r\n" +
                "K01-D-006 / K01-P-007 Hermetic Magnetic Can / Gate04D-C2R1\r\n" +
        ...
        static string[] GenerateDrawing(string modelPath, string drawingNo, string engineeringNote)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    SetProperty(dm, "K01_DrawingStatus", "DRAFT_C2R1_API");
                    SetProperty(dm, "K01_SourceModel", modelPath);

                    dm.ForceRebuild3(false);

                    string stem = drawingNo + "_" + Path.GetFileNameWithoutExtension(modelPath) + "_DRAFT_C2R1_API";
