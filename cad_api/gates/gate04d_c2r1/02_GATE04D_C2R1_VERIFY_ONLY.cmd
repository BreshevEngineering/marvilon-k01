...
echo ================================================================================
echo K01 Gate04D-C2R1 VERIFY - TARGETED J2 MATE MIGRATION
echo ================================================================================
...
echo [1/2] Compiling...
"%CSC%" /nologo /platform:x64 /target:exe /out:"bin\K01Gate04D_C2R1_Verify.exe" ^
 /reference:"%SLD%" /reference:"%CONST%" /reference:System.Web.Extensions.dll ^
 "K01Gate04D_C2R1_Verify.cs"
...
echo.
echo [2/2] Running...
"bin\K01Gate04D_C2R1_Verify.exe"
set RC=%ERRORLEVEL%
...
echo D:\BreshevEngineering\marvilon-k01\reports\cad\current\K01_GATE04D_C2R1_VERIFY.json
echo D:\BreshevEngineering\marvilon-k01\reports\cad\current\K01_GATE04D_C2R1_VERIFY_*.log
echo.
pause
exit /b %RC%
