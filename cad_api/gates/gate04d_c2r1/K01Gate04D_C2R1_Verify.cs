...
namespace Marvilon.K01.Gate04D_C2R1.Verify
{
    public sealed class Rpt
    {
        public string schema="k01_gate04d_c2r1_verify_v1";
    ...
    public static class Program
    {
        ...
        const string P003C=@"D:\Marvilon\K01\cad\candidates\gate04d_c2r1\K01-P-003_Cartridge_Body_GATE04D_C2R1_CANDIDATE.SLDPRT";
        const string P007C=@"D:\Marvilon\K01\cad\candidates\gate04d_c2r1\K01-P-007_Hermetic_Magnetic_Can_GATE04D_C2R1_CANDIDATE.SLDPRT";
        const string VDIR=@"D:\Marvilon\K01\cad\candidates\gate04d_c2r1\verification";
        const string VASM=@"D:\Marvilon\K01\cad\candidates\gate04d_c2r1\verification\K01-A-001_GATE04D_C2R1_VERIFY.SLDASM";
        ...
        public static int Main(string[] args)
        {
            try
            {
                ...
                logPath=Path.Combine(RDIR,"K01_GATE04D_C2R1_VERIFY_"+stamp+".log");
                jsonPath=Path.Combine(RDIR,"K01_GATE04D_C2R1_VERIFY.json");
                File.WriteAllText(logPath,"K01 Gate04D-C2R1 Verify\r\n");
        ...
        static void Verify()
        {
            ...
            try
            {
                ...
                SetProp(doc,"K01_GATE","Gate04D_C2R1_VERIFY");
