...
echo ================================================================================
echo MARVILON K01 Gate04D-C2R1 - DRAFT API DRAWINGS
echo ================================================================================
...
echo Compiler        : %CSC%
echo.
echo [1/2] Compiling K01Gate04D_C2R1_Drawings.cs...
"%CSC%" /nologo /platform:x64 /target:exe /out:"bin\K01Gate04D_C2R1_Drawings.exe" /reference:"%SLD%" /reference:"%CONST%" /reference:System.Web.Extensions.dll "K01Gate04D_C2R1_Drawings.cs"
if errorlevel 1 (
  echo.
  echo COMPILE FAILED.
...
echo.
echo [2/2] Running K01Gate04D_C2R1_Drawings.exe...
"bin\K01Gate04D_C2R1_Drawings.exe"
set "RC=%ERRORLEVEL%"
if not "%RC%"=="0" (
  echo.
