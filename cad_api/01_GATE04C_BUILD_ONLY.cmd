...
echo ================================================================================
echo MARVILON K01 Gate04C - NATIVE P003/P007 BUILD
echo ================================================================================
...
echo Compiler        : %CSC%
echo.
echo [1/2] Compiling K01Gate04C_Build.cs...
"%CSC%" /nologo /platform:x64 /target:exe /out:"bin\K01Gate04C_Build.exe" /reference:"%SLD%" /reference:"%CONST%" /reference:System.Web.Extensions.dll "K01Gate04C_Build.cs"
if errorlevel 1 (
  echo.
  echo COMPILE FAILED.
...
echo.
echo [2/2] Running K01Gate04C_Build.exe...
"bin\K01Gate04C_Build.exe"
set "RC=%ERRORLEVEL%"
if not "%RC%"=="0" (
  echo.
