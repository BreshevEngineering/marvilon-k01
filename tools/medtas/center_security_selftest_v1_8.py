...
def main():
    ...
    html=(r/'K01_Command_Center_v11.html').read_text(encoding='utf-8');js=(r/'control/medtas/v1/center/assets/app_v11.js').read_text(encoding='utf-8');srv=(r/'tools/medtas/center_server_v11.py').read_text(encoding='utf-8')
