...
def load_graph(root):
    p=root/'control/medtas/v1/graph/K01_engineering_build_graph_v1_7.json'
...
def build_snapshot(root,graph,cad,derived):
    ...
    register_build(root,'K01.SNAPSHOT.A001',{'tool':'build_downstream_v1_7.py','stage':'canonical_snapshot_v1_4'}); return payload
...
def build_tolerance(root,snapshot):
    ...
    out=root/'reports/medtas/tolerance/current/K01_TOLERANCE_A001_v1.json'; dump(out,payload); register_build(root,'K01.TOL.A001',{'tool':'build_downstream_v1_7.py','stage':'tolerance_v1_4'}); return payload
...
def build_structural(root,snapshot):
    ...
    out=root/'reports/medtas/structural/current/K01_STRUCTURAL_MODEL_P006_v1.json'; dump(out,payload); register_build(root,'K01.STRUCT.MODEL.P006',{'tool':'build_downstream_v1_7.py','stage':'solver_neutral_structural'}); return payload
...
def build_drawing_model(root,snapshot,tol):
    ...
    out=root/'reports/medtas/drawing/current/K01_DRAWING_MODEL_GATE04E_v1.json'; dump(out,payload); register_build(root,'K01.DRAWING.MODEL.GATE04E',{'tool':'build_downstream_v1_7.py','stage':'drawing_intent'}); return payload
...
def build_bom(root,snapshot):
    ...
    out=root/'reports/medtas/bom/current/K01_BOM_MODEL_A001_v1.json'; dump(out,payload); register_build(root,'K01.BOM.MODEL.A001',{'tool':'build_downstream_v1_7.py','stage':'canonical_bom'}); return payload
