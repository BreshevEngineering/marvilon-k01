...
REQUIRED=[
 ...
 ('semantic_equivalence','reports/control/K01_FINAL_ASSEMBLY_SEMANTIC_VERIFY_CURRENT.json',{'PASS'}),
 ('technical_filter_evidence','reports/control/K01_TECHNICAL_FILTER_EVIDENCE_CURRENT.json',{'PASS'}),
 ('mbom','reports/bom/current/K01_MBOM_A001_CURRENT.json',{'PASS'}),
...
def main():
 ...
 for name,rels in [('drawing',['reports/drawing/current/K01_DRAWING_QA_CURRENT.json']),('requirements',['reports/control/K01_REQUIREMENTS_COVERAGE_CURRENT.json'])]:
  found=None
  for rel in rels:
 ...
 out=r/'release/R01'
 if out.exists(): print('HOLD R01 already exists; never overwrite a release'); return 3
