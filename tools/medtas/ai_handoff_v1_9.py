...
PATTERNS=[
  ...
  'control/medtas/v1/graph/K01_engineering_build_graph_v1_9.json','control/medtas/v1/spec/*.json','control/medtas/v1/spec/*.md',
...
def build_handoff(root:Path):
    ...
    meta={'schema':'k01.ai_handoff_manifest.v1_9','generated_local_time':time.strftime('%Y-%m-%d %H:%M:%S'),'project':'K01','file_count':len(manifest),'files':manifest,
