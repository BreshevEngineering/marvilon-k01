...
def add_collar_component(asm, collar_path):
    # SW2018 AddComponent5:
    # CompName, ConfigOption(0=current), NewConfigName,
    ...
    if e or comp is None:
        raise RuntimeError(f"AddComponent5 collar failed: {e or 'returned None'}")
    return comp
...
def main():
    ...
    collar=add_collar_component(asm,collar_path)
