...
echo ============================================================
echo K01 SolidWorks API Gate 01 - v04
echo ============================================================
echo.

if not exist "cad_api\sw_api_probe_v04.py" (
  echo [ERROR] cad_api\sw_api_probe_v04.py not found.
  pause
  exit /b 2
)
...
if %RC% EQU 0 (
  ...
  echo Send reports\CAD_SNAPSHOT_probe_v04.json.
) else (
